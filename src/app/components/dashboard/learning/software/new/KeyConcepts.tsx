    ...
    return (
        <div className="bg-gray-50 dark:bg-[#282A42] p-4 rounded-lg">
            <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-medium text-gray-800 dark:text-white">Key Concepts</h3>
                <button
                    type="button"
                    onClick={addConcept}
            ...
            {concepts.map((concept, index) => (
                <div key={`concept-${index}`} className="mb-4 p-3 border border-gray-200 dark:border-gray-700 rounded-md">
                    <div className="flex justify-between items-center mb-2">
                        <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300">Concept #{index + 1}</h4>
                        {concepts.length > 1 && (
                            <button
                                type="button"
